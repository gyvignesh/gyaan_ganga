...
<label>Name</label>
<input class="form-control" placeholder="Enter your name" name="company" required type="text"> 
</div>
...
<input class="form-control" placeholder="Eg: Civil, Computer Software etc" name="type" required type="text"> 
</div>
