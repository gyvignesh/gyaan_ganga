				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../job-list.php">Project List</a>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">Gyaan Ganga Project Lists</a></li>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-item for-employer">
										...
										<?php 
										if ($logo == null) {
										print '<center>project Logo Here</center>';
										}else{
									...
									<div class="admin-user-action text-center">
										...
										<a href="post-job.php" class="btn btn-primary btn-sm btn-inverse">Post a Project</a>
									...
									<ul class="admin-user-menu clearfix">
										...
										<li>
											<a href="../company.php?ref=<?php echo "$myid"; ?>"><i class="fa fa-briefcase"></i> Project Overview</a>
										</li>
										<li>
											<a href="my-jobs.php"><i class="fa fa-bookmark"></i> Posted Projects</a>
										</li>
										<li>
											...
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-8">
													...
													<div class="form-group">
														...
														<input name="company" placeholder="Enter project name" type="text" class="form-control" value="<?php echo "$compname"; ?>" required>
													</div>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Gyaan Ganga</h5>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="../">Home</a></li>
											<li><a href="../job-list.php">Project List</a></li>
											<li><a href="../employers.php">project host</a></li>
											<li><a href="../employees.php">members</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Narapally</p>
								<p>Email : <a href="">Gyaanganaga@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">9848032919</a></p>
