				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="job-list.php">Projects List</a>
							</li>
							
							<li>
								<a href="employers.php">Project Hosters</a>
							</li>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">Register as Project Host</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as User</a>
						</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your next Project or career on Gyaan Ganga</p>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<br><h2>Random Project Hosters</h2>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Gyan Ganga</h5>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="employers.php">Project Hosters</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="">gyaanganga@gamil.com</a></p>
								<p>Phone : <a href="">9395552326</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Gyaan Ganga</p>
